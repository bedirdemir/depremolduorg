    ...
    <section class="py-3 px-2 min-h-screen lg:px-0">
        <div class="flex flex-col gap-4 mb-5">
            ...
            <div class="w-full p-6 border border-gray-200 rounded-lg shadow">
                ...
                <p class="mb-3 font-normal text-sm lg:text-base text-gray-700 dark:text-gray-400">Depremlerde can ve mal kayıplarının artmasının en önemli nedenlerinden biri de sarsıntı sırasında kişilerin kendilerini nasıl koruyacaklarını ve ne yapmaları gerektiğini bilmemeleridir. Peki, deprem anında ne yapmanız gerekiyor?</p>
            ...
            <div class="w-full p-6 border border-gray-200 rounded-lg shadow">
                ...
                <p class="mb-3 font-normal text-sm lg:text-base text-gray-700 dark:text-gray-400">Panik yapmayın! Panik yapmaya başladıktan sonra hata yapmaya da başlarsınız! Binanızın önünden uzaklaşın! Deprem sonrasında dışarı çıktıktan sonra binanızın önünde beklemeyin.</p>
            ...
            <div class="w-full p-6 border border-gray-200 rounded-lg shadow">
                ...
                <p class="mb-3 font-normal text-sm lg:text-base text-gray-700 dark:text-gray-400">Depremlerde yaşanan yaralanmaların en yaygın sebebi, sarsıntılar sırasında yüksek raflardan ve tavandan düşen/fırlayan cisimlerdir. Çök Kapan Tutun Yöntemi'nde, masa benzeri bir cismin altına girme önerisinin nedeni, düşen büyük bloklardan korunmak değil, düşen ve fırlayan cisimlerden (televizyon, lambalar, cam nesneler, kitaplar ve kitaplıklar gibi) korunmaktır.</p>
            ...
            <div class="w-full p-6 border border-gray-200 rounded-lg shadow">
                ...
                <p class="mb-3 font-normal text-sm lg:text-base text-gray-700 dark:text-gray-400">Deprem dediğimiz doğa olayı, yer kabuğundaki kırılmalar nedeniyle ortaya çıkan titreşimlerin dalgalar halinde yayılmasıdır. Bu olay, sanılanın aksine, yerkabuğunun hareketsiz değil de hareketli olduğunun bir göstergesi olup, kaotik süreçler içeren ve fizik bilimi başta olmak üzere diğer bilim dalları tarafından da incelenen bir olgudur.</p>
            ...
            <div class="w-full p-6 border border-gray-200 rounded-lg shadow">
                ...
                <p class="mb-3 font-normal text-sm lg:text-base text-gray-700 dark:text-gray-400">Çocuklar için anlayabilecekleri bir dilde depremler, depremlerin oluşumu ve afet durumu hakkında genel bilgiler.</p>
            ...
            <div class="w-full p-6 border border-gray-200 rounded-lg shadow">
                ...
                <p class="mb-3 font-normal text-sm lg:text-base text-gray-700 dark:text-gray-400">Modern bilim ve teknolojimiz çerçevesinde depremleri önceden tahmin etmenin hiçbir yolu bulunmamaktadır. Deprem tahmini yaptığı iddia edilen kişi ve kurumlar tamamen istatistiki yalanlara ve hilelere başvurmaktadırlar.</p>
            ...
            <div class="w-full p-6 border border-gray-200 rounded-lg shadow">
                ...
                <p class="mb-3 font-normal text-sm lg:text-base text-gray-700 dark:text-gray-400">Deprem ışıkları, depremler sırasında veya öncesinde görülebilen levha biçimli şimşekler, ışık topları, ışık akıntıları ve sabit parlamalar gibi olaylardır.</p>
            ...
            <div class="w-full p-6 border border-gray-200 rounded-lg shadow">
                ...
                <p class="mb-3 font-normal text-sm lg:text-base text-gray-700 dark:text-gray-400">Tsunamiler, yeryüzünde bilinen en yıkıcı doğa olaylarından birisidir. Gelgit dalgası olarak da bilinen "tsunami", genellikle depremler, volkanik patlamalar ve diğer su altı patlamaları etkisiyle çok miktarda suyun yer değiştirmesi sonucu okyanus, deniz ve büyük göllerde meydana gelebilen, sıra dışı yükseklikteki ve uzunluktaki dalgalara verilen isimdir.</p>
            ...
            <div class="w-full p-6 border border-gray-200 rounded-lg shadow">
                ...
                <p class="mb-3 font-normal text-sm lg:text-base text-gray-700 dark:text-gray-400">Depremin Büyüklüğü ile Şiddeti Arasında Ne Fark Var? Bir Deprem Sırasında Ne Kadar Enerji Açığa Çıkar?</p>
