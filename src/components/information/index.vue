    ...
    <section class="py-3 px-2 min-h-screen lg:px-0">
        <div class="flex flex-col gap-4 mb-5">
            ...
            <div class="w-full p-6 border border-gray-200 rounded-lg shadow bg-[#FCFFE760]">
                ...
                <p class="mb-3 font-normal text-sm lg:text-base text-gray-700">Depremlerde can ve mal kayıplarının artmasının en önemli nedenlerinden biri de sarsıntı sırasında kişilerin kendilerini nasıl koruyacaklarını ve ne yapmaları gerektiğini bilmemeleridir. Peki, deprem anında ne yapmanız gerekiyor?</p>
            ...
            <div class="w-full p-6 border border-gray-200 rounded-lg shadow bg-[#FCFFE760]">
                ...
                <p class="mb-3 font-normal text-sm lg:text-base text-gray-700">Çocuklar için anlayabilecekleri bir dilde depremler, depremlerin oluşumu ve afet durumu hakkında genel bilgiler.</p>
            ...
            <div class="w-full p-6 border border-gray-200 rounded-lg shadow bg-[#FCFFE760]">
                ...
                <p class="mb-3 font-normal text-sm lg:text-base text-gray-700">Modern bilim ve teknolojimiz çerçevesinde depremleri önceden tahmin etmenin hiçbir yolu bulunmamaktadır. Deprem tahmini yaptığı iddia edilen kişi ve kurumlar tamamen istatistiki yalanlara ve hilelere başvurmaktadırlar.</p>
            ...
            <div class="w-full p-6 border border-gray-200 rounded-lg shadow bg-[#FCFFE760]">
                ...
                <p class="mb-3 font-normal text-sm lg:text-base text-gray-700">Deprem ışıkları, depremler sırasında veya öncesinde görülebilen levha biçimli şimşekler, ışık topları, ışık akıntıları ve sabit parlamalar gibi olaylardır.</p>
