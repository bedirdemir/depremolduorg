<template>
    <header class="flex justify-between items-center py-5 px-2 border-b border-gray-300 lg:px-1">
        ...
        <g>
            ...
            <h1 class="text-secondary text-xl">depremoldu.org</h1>
        </div>
        <div>
            <a class="flex items-center rounded bg-secondary text-white p-2 cursor-pointer" @click="$store.dispatch('getData')">
